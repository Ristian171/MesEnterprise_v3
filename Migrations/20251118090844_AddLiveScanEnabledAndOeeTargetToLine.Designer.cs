...
namespace MesEnterprise.Migrations
{
    ...
    [Migration("20251118090844_AddLiveScanEnabledAndOeeTargetToLine")]
    partial class AddLiveScanEnabledAndOeeTargetToLine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MesEnterprise.Models.Core.Line", b =>
                {
                    ...
                    b.Property<bool>("LiveScanEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("live_scan_enabled");
            ...
            modelBuilder.Entity("MesEnterprise.Models.Maintenance.InterventieTichet", b =>
                {
                    ...
                    b.Property<int?>("TehnicianAsignatId")
                        .HasColumnType("integer")
                        .HasColumnName("tehnician_asignat_id");
                    ...
                    b.HasIndex("TehnicianAsignatId")
                        .HasDatabaseName("ix_interventie_tichet_tehnician_asignat_id");
            ...
            modelBuilder.Entity("MesEnterprise.Models.Maintenance.InterventieTichet", b =>
                {
                    ...
                    b.HasOne("MesEnterprise.Models.Core.User", "TehnicianAsignat")
                        .WithMany()
                        .HasForeignKey("TehnicianAsignatId")
                        .HasConstraintName("fk_interventie_tichet_user_tehnician_asignat_id");
